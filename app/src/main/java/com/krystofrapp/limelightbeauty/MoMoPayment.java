...
public class MoMoPayment extends AppCompatActivity {
    ...
    private TextInputEditText transactionId, momoPhoneNumber;
            ...
            builder.setCancelable(false)
                    ...
                    .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            new AlertDialog.Builder(MoMoPayment.this)
                                    ...
                                    .setPositiveButton("CONFIRM", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            Intent intent = new Intent(MoMoPayment.this, Homepage.class);
